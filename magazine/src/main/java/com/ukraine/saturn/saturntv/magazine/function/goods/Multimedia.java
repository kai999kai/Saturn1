    ...
    private void result() {
        ...
        if (Arrays.equals(arr_category, NAME_ARR_DVD_ALL)) {
            ...
            arr_naming = new String[]{
                    ...
                    "LAN Интернет:", "Аксессуары:", "Файловая система:", "Поддерживаемые форматы:",
                    "кодеки:", "3D-видео:", "аудио:", "изображения:", "субтитры:"};
            arr_descriptions = new String[]{
                    ...
                    "FAT16, FAT32, NTFS", "",
                    "AVI, DAT, DIVX, FLV, Google VP8, WMV9, XVID, H.263, H.264, IFO, MKV, MOV, MPG," +
                            " MP4, MPEG1/2/4, REAL Media, RM, RMVB, Sorenson Spark, VOB, WMV",
                    "TS, M2TS",
